      ...
      <div className="p-8 rounded shadow-xl sm:p-16">
        <div className="flex flex-col lg:flex-row">
          <div className="mb-6 lg:mb-0 lg:w-1/2 lg:pr-5">
            <h2 className="font-sans text-3xl font-bold tracking-tight text-red-800 sm:text-4xl sm:leading-none">
              Web Development 
    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="p-8 rounded shadow-xl sm:p-16">
        ...
        <div className="mb-6 lg:mb-0 lg:w-1/2 lg:pr-4">
            <h3 className="font-sans text-3xl font-bold tracking-tight text-red-800 sm:text-4xl sm:leading-none">
              <br className="hidden md:block" />
              CRM  Services{' '}
              <span className="inline-block text-deep-purple-accent-400">
