    ...
    <div className="space-y-8 xl:col-span-1">
      <Image
       className="h-10 w-auto sm:h-11 m-0"
            ...
            <p className="text-white-500 text-centre bg-green-400">
                Making the world a better place through constructing elegant hierarchies.
              </p>
              <h3 className="text-sm font-semibold text-green-600 tracking-wider uppercase text-center mt-2">Quick Links</h3>
              <div className="mt-12 grid grid-flow-row gap-8 xl:mt-0 xl:rows-span-2 pt-20">
              <div className="md:grid md:grid-flow-row md:gap-8">
                <div>
                  
                  <ul role="list" className="ml-10 space-x-4 mb-8 grid grid-flow-col gap-1 ">
